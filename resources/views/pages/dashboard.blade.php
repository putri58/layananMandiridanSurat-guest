            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <p class="hosting_text">Kami adalah inovator di balik platform digital yang merevolusi cara
                            masyarakat berinteraksi dengan layanan administrasi surat-menyurat. Layanan Mandiri & Surat
                            dirancang secara komprehensif dan terstruktur untuk memastikan setiap tahapan pengurusan dokumen
                            berjalan efisien, transparan, dan aman </p>
                    </div>
                    <div class="col-md-6">
                        ...
                        <div class="carousel-item active">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p class="testimonial_text"> Siti Rahayu, Ibu Rumah Tangga, Pengguna sejak: 2023</p>
                                    ...
                                    <div class="client_img"><img
                                            src="{{ asset('assets-guest/images//client-img.png') }}"></div>
                                    <h4 class="client_name">Siti Rahayu</h4>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1 class="testimonial_taital">Testimoni</h1>
                                    <p class="testimonial_text">Jeon Jungkook, Penyanyi, Pengguna Sejak 2024</p>
                                    <div class="testimonial_section_2">
                                    ...
                                    <div class="client_img"><img
                                            src="{{ asset('assets-guest/images//client-img.png') }}"></div>
                                    <h4 class="client_name">Jeon Jungkook</h4>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item">
                            <div class="row">
                                <div class="col-md-12">
                                    <h1 class="testimonial_taital">Testimoni</h1>
                                    <p class="testimonial_text">Mersya Grande, Mahasiswa, Pengguna Sejak 2025</p>
                                    <div class="testimonial_section_2">
                                    ...
                                    <div class="client_img"><img
                                            src="{{ asset('assets-guest/images//client-img.png') }}"></div>
                                    <h4 class="client_name">Mersya Grande</h4>
                                </div>
                            </div>
                        </div>
                    </div>
